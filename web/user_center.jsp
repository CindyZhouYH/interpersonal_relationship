            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (i = 1; i <= msg.length; i++) {
                        ...
                        document.getElementById("friend_" + i).value = msg[i - 1].username;
                    }
                },
                error: function (data) {
                    alert("errorGettingFriend");
                    console.log(data);
                }
            });
        }
        ...
        <div class="panel">
            ...
            <form action="${pageContext.request.contextPath}/user/updateInform" method="post">
                <table class="table1">
                    ...
                    <tr>
                        <td><input type="text" id="friend_1" name="friend_1" style="display: none"></td>
                        <td><input type="text" id="friend_2" name="friend_2" style="display: none"></td>
                        <td><input type="text" id="friend_3" name="friend_3" style="display: none"></td>
                        <td><input type="text" id="friend_4" name="friend_4" style="display: none"></td>
                        <td><input type="text" id="friend_5" name="friend_5" style="display: none"></td>
                    </tr>
