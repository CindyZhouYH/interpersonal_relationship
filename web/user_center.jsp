    ...
    <div class = "content">
        <div class = "panel">
            ...
            <table class = "table1" >
                ...
                <tr>
                    <td><input type = "text" id = "username" value ="111"></td>
                    <td><input type = "text" id = "password" value ="2222"></td>
                    <td><input type = "text" id = "name" value ="333"></td>
                    <td><input type = "text" id = "email" value ="444"></td>
                </tr>
                <thead>
                <th id = "school1"></th>
                <th id = "id1"></th>
